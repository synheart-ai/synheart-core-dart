...
class UploadRequest {
  ...
  factory UploadRequest.fromJson(Map<String, dynamic> json) => UploadRequest(
    ...
    metadata: UploadMetadata.fromJson(json['metadata'] as Map<String, dynamic>),
...
class UploadResponse {
  ...
  factory UploadResponse.fromJson(Map<String, dynamic> json) => UploadResponse(
    ...
    snapshotIds: (json['snapshot_ids'] as List<dynamic>?)?.cast<String>(),
  ...
  factory UploadErrorResponse.fromJson(Map<String, dynamic> json) =>
      UploadErrorResponse(
        error: json['error'] is Map
            ? UploadErrorDetail.fromJson(json['error'] as Map<String, dynamic>)
            : null,
...
class UploadErrorDetail {
  ...
  UploadErrorDetail({required this.code, required this.message, this.details});
