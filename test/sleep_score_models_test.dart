// Unit tests for Dart typed models mirroring the Rust `SleepScoreResult`
...
void main() {
  group('SleepScoreInput JSON shape', () {
    test('segmented night round-trips to the Rust-expected schema', () {
    ...
    test('aggregated night includes all total fields', () {
      ...
      final json = jsonDecode(input.toJsonString()) as Map<String, Object?>;
      final totals = ((json['tonight'] as Map)['detail']
          as Map)['totals'] as Map<String, Object?>;
    ...
    test('vendor-score night carries only the scalar', () {
      ...
      final detail = ((jsonDecode(input.toJsonString())
          as Map<String, Object?>)['tonight'] as Map)['detail'] as Map<String, Object?>;
  ...
  group('SleepScoreResult JSON shape', () {
    test('parses the full Rust shape', () {
  ...
  group('Enum wire contracts', () {
    test('path wire values match Rust serde snake_case', () {
    ...
    test('mode wire values match Rust serde snake_case', () {
