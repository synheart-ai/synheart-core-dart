...
/// HSI screen showing the raw HSI JSON from the Synheart Runtime
class HsiStateScreen extends StatelessWidget {
  const HsiStateScreen({super.key});
        ...
        builder: (context, provider, child) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'HSI JSON (from the Synheart Runtime)',
