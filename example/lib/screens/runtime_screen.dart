...
class _RuntimeScreenState extends State<RuntimeScreen> {
  ...
  final TextEditingController _labOpenLabelController = TextEditingController(
    text: 'baseline_rest',
  );
  final TextEditingController _labSetValuesController = TextEditingController(
    text: '{"score": 0}',
  );
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                FilledButton(onPressed: _manualTick, child: const Text('Tick')),
              ],
            ),
          ],
        ),
          ...
          children: [
            ...
            if (!isLabAvailable) ...[
              ...
              if (_labActive) ...[
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (v) =>
                            setState(() => _labOpenWindowType = v ?? 'phase'),
                      ),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                ...
                const SizedBox(height: 8),
                Text(
                  'Open windows: ${_openWindowIds.length}',
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: _openWindowIds
                              ...
                              .toList(),
                          onChanged: (v) =>
                              setState(() => _labSelectedWindowId = v),
                        ),
                      ),
                      const SizedBox(width: 8),
                      FilledButton.tonal(
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: _openWindowIds
                              ...
                              .toList(),
                          onChanged: (v) =>
                              setState(() => _labSetValuesWindowId = v),
                        ),
                      ),
                      const SizedBox(width: 8),
                      Expanded(
  ...
  void _labStart() {
    ...
    final userId =
        provider.userId ?? 'user_${DateTime.now().millisecondsSinceEpoch}';
  ...
  void _labOpenWindow() {
    ...
    final nowMs = DateTime.now().millisecondsSinceEpoch;
    final label = _labOpenLabelController.text.trim().isEmpty
        ? null
        : _labOpenLabelController.text.trim();
  ...
  void _labCloseWindow() {
    final id =
        _labSelectedWindowId ??
        (_openWindowIds.isNotEmpty ? _openWindowIds.first : null);
    if (id == null) {
    ...
    setState(() {
      ...
      _labSelectedWindowId = _openWindowIds.isNotEmpty
          ? _openWindowIds.first
          : null;
      _labSetValuesWindowId = _openWindowIds.isNotEmpty
          ? _openWindowIds.first
          : null;
    });
